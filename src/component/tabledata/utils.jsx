...
// export function applyFilter({ inputData, comparator, filterName, columnId }) {
...
//         ) ||
//         (columnId && item[columnId] && item[columnId].toString().toLowerCase().indexOf(filterName.toLowerCase()) !== -1)
//     );
//   }
